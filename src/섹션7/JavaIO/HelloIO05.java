...
public class HelloIO05 {
    public static void main(String[] args) throws Exception{
        ...
        // FileOutputStream은 write(int); int의 마지막 byte만 저장함
        // OutputStreamWriter 생성자에 들어온 OutputStream의 write()를 이용하여 쓴다.
        // OutputStreamWriter는 write(int); int의 끝부분에 char를 저장함
        // PrintWriter 생성자에 들어온 OutputStreamWriter의 write()를 이용하여 쓴다.
